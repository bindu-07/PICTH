...
class Injector {
    ...
    companion object {
        ...
        private fun networkInterceptor(): Interceptor {
            return Interceptor { chain ->
                ...
                val cacheControl: CacheControl = CacheControl.Builder()
                    ...
                    .build()
                val request: Request
                request = if (!TextUtils.isEmpty(helper.getString(Constants.AUTH_KEY))) {
                    chain.request().newBuilder()
                        .header("Authorization", "Bearer " + helper.getString(Constants.AUTH_KEY))
        ...
        fun provideApi(): ApiInterface {
            return provideRetrofit(Constants.BASE_URL).create(ApiInterface::class.java)
        }

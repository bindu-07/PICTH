...
class CircleAdapter(private val items: List<Item>) : RecyclerView.Adapter<CircleAdapter.CircleViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CircleViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.rvstories_item, parent, false)
